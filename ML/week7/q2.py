...
def train_with_l1_regularization(model, train_loader, val_loader, epochs=10, l1_lambda=0.00001):
...
train_with_l1_regularization(model_l1, train_loader, val_loader, epochs=10, l1_lambda=0.00001)
