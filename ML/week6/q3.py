...
# Define the CNN model (this is a basic MNIST model)
class CNNModel(nn.Module):
    ...
    def forward(self, x):
        ...
        # Check the size of the output before flattening (Optional for debugging)
...
for epoch in range(start_epoch, num_epochs):
    ...
    # Save the best model based on validation loss (for example, here we use training loss)
