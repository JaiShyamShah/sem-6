...
class FeedForwardNN(nn.Module):
    def __init__(self):
        ...
        # Define the layers
        self.fc1 = nn.Linear(28 * 28, 100)  # First hidden layer (784 inputs to 128 units)
        self.fc2 = nn.Linear(100, 100)  # Second hidden layer (128 inputs to 64 units)
        self.fc3 = nn.Linear(100, 10)  # Output layer (64 inputs to 10 outputs, one for each digit)
